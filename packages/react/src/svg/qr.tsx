...
function QrComponent(props: QrProps, ref: Ref<SVGSVGElement>) {
  ...
  function generateQr() {
    ...
    const size = Math.floor(initialSvgSize / (qr.gridSize + 1.5));
  ...
  useEffect(() => {
    ...
    generateQr();
    // eslint-disable-next-line react-hooks/exhaustive-deps -- intentionally curated dependency list
  }, [
    props.input,
